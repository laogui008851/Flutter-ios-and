...
Additionally, make sure you have [deployed](https://www.doubao.comzh-Hans/guides/gettingStarted/dockerCompose) the latest version of the OpenIM Server. After deployment, you can compile the project and connect it to your server for testing.
