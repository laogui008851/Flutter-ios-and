...
class Config {
  ...
  /// web.rentsoft.cn
  /// 203.56.175.233
  static const _host = "sp.junapi.xyz";
  ...
  static String get appAuthUrl {
    ...
    // to c
    return url ?? (_isIP ? "http://$_host:50008" : "https://$_host/chat");
  }
  ...
  static String get imApiUrl {
    ...
    return url ?? (_isIP ? 'http://$_host:50002' : "https://$_host/api");
  }
  ...
  static String get imWsUrl {
    ...
    return url ?? (_isIP ? "ws://$_host:50001" : "wss://$_host/msg_gateway");
  }
