const Map<String, String> zh_CN = {
  ...
  "userID": "用户ID",
  "username": "用户名",
  "plsEnterUsername": "请输入您的用户名",
  "plsEnterRightUsername": "用户名只能包含字母和数字，长度3-20位",
  "phoneNumber": "手机号",
  ...
  "wrongNicknameFormat": "用户名只允许字母大小写和数字，且必须为9位",
  ...
  'callFail': '你无法呼叫该用户',
  'search_by_phone_and_uid': '通过用户名/ID号/搜索添加',
  'backgroundPermissionTitle': '后台运行权限',
  'backgroundPermissionDesc': '为了确保您能及时收到消息通知，请开启以下权限：',
  'batteryOptimization': '电池优化',
  'batteryOptimizationDesc': '关闭电池优化，保持后台运行',
  'autoStart': '自启动权限',
  'autoStartDesc': '允许自启动，确保消息推送正常',
  'currentDevice': '当前设备',
  'notNow': '暂不设置',
  'goToSettings': '去设置',
  'batteryOptimizationTitle': '关闭电池优化',
  'batteryOptimizationContent': '为了确保消息能够及时送达，建议关闭电池优化。关闭后，应用可以在后台正常接收消息推送。',
};
