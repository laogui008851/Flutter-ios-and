...
class StrRes {
  ...
  static String get plsEnterUsername => 'plsEnterUsername'.tr;
  static String get plsEnterRightUsername => 'plsEnterRightUsername'.tr;
  ...
  static String get wrongNicknameFormat => 'wrongNicknameFormat'.tr;
  ...
  // Android 后台权限引导相关
  static String get backgroundPermissionTitle => 'backgroundPermissionTitle'.tr;
  static String get backgroundPermissionDesc => 'backgroundPermissionDesc'.tr;
  static String get batteryOptimization => 'batteryOptimization'.tr;
  static String get batteryOptimizationDesc => 'batteryOptimizationDesc'.tr;
  static String get autoStart => 'autoStart'.tr;
  static String get autoStartDesc => 'autoStartDesc'.tr;
  static String get currentDevice => 'currentDevice'.tr;
  static String get notNow => 'notNow'.tr;
  static String get goToSettings => 'goToSettings'.tr;
  static String get batteryOptimizationTitle => 'batteryOptimizationTitle'.tr;
  static String get batteryOptimizationContent =>
      'batteryOptimizationContent'.tr;
}
